      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center sm:text-left">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          ...
          {stats && stats.length > 0 && (
            <div className="hidden sm:flex gap-8 bg-white/40 border border-zinc-200/30 p-6 rounded-2xl backdrop-blur-md">
              {stats.map((stat, idx) => (
                <div key={idx} className="flex gap-8 items-center">
                  ...
                  <div>
                    <div className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">
                      {stat.value}
                    </div>

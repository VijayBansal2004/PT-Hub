    ...
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3 font-sans select-none">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <span className="text-[10px] font-extrabold tracking-widest text-zinc-400 uppercase px-2 py-1">
              Contact Us
            </span>
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-xs font-extrabold text-zinc-800 leading-tight group-hover:text-blue-700 transition-colors">Call Support</span>
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-xs font-extrabold text-zinc-800 leading-tight group-hover:text-green-700 transition-colors">WhatsApp Us</span>
                <span className="text-[11px] text-zinc-400 mt-0.5">
                  {demoCallNumber}
                </span>
              </div>

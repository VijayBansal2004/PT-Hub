  ...
  return (
    <footer className="mt-auto border-t border-zinc-200/50 bg-white text-zinc-600 transition-colors duration-300 w-full font-sans py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Upper footer grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center pb-8 border-b border-zinc-200/30">
          {/* Left Side: Logo */}
          ...
          <div className="flex justify-center">
            <nav>
              <ul className="flex flex-wrap justify-center gap-6 text-sm font-semibold text-zinc-500">
                <li>
                  <a
                    href="/products"
          ...
          {/* Right Side: Social Icons (Insta, FB, Whatsapp, Phone) */}
          <div className="flex justify-center md:justify-end gap-3.5">
            ...
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200 bg-white hover:bg-zinc-50 hover:text-pink-600 transition-all hover:scale-105 shadow-sm cursor-pointer">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200 bg-white hover:bg-zinc-50 hover:text-emerald-600 transition-all hover:scale-105 shadow-sm cursor-pointer">
              <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
            ...
            <a
              ...
              href="tel:+15550199"
              className="flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200 bg-white hover:bg-zinc-50 hover:text-indigo-600 transition-all hover:scale-105 shadow-sm cursor-pointer">
              <svg
        ...
        {/* Lower footer copyright (centered) */}
